...
# load yolo packages
from data.repos.Detector.yolov5.models.experimental import attempt_load
from data.repos.Detector.yolov5.utils.datasets import letterbox
from data.repos.Detector.yolov5.utils.general import non_max_suppression, scale_coords
from data.repos.Detector.yolov5.utils.torch_utils import select_device
